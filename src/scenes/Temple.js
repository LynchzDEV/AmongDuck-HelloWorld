...
class Temple extends Phaser.Scene {
    ...
    addForegroundElements(width, height, mapWidth, floorHeight) {
        ...
        let xPositions = [
            0, 450, 1200, 1500, 2300, 2550, 2950, 3700, 3850, 4900, 5100, 5555,
            6300, 6500,
        ];
        let yPositions = [
            450, 550, 600, 650, 450, 500, 550, 600, 600, 450, 475, 525, 600,
            650,
        ];
        ...
        let xPositionsTree = [
            -300, 305, 1100, 1600, 2300, 2865, 3650, 4100, 4850, 5425, 6200,
            6650,
        ];
        let yPositionsTree = [
        ...
        let scales = [
            0.65, 0.55, 0.65, 0.55, 0.65, 0.55, 0.65, 0.6, 0.6, 0.55, 0.65,
            0.57,
        ];
        let count = 1;
