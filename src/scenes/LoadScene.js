...
class LoadScene extends Phaser.Scene {
    ...
    loadBackground() {
        ...
        this.load.image(
            "sky2",
            path.join(BACKGROUND_TEMPLE_PATH, "skyP02.png")
        );
        this.load.image(
            "sky3",
            path.join(BACKGROUND_TEMPLE_PATH, "skyP03.png")
        );
        this.load.image(
            "bgTree",
        ...
        this.load.image(
            "bushes",
            path.join(BACKGROUND_TEMPLE_PATH, "Bushes.png")
        );
    }
    loadPlatforms() {
        this.load.image(
            "platform",
            path.join(PLATFORM_GAME_PATH, "platform.png")
        );
        this.load.image(
            "platform2",
    ...
    loadComponents() {
        ...
        this.load.image(
            "lantern",
            path.join(COMPONENT_GAME_PATH, "lantern.png")
        );
        ...
        this.load.image(
            "jumppad1",
            path.join(COMPONENT_GAME_PATH, "jumppad1.png")
        );
        this.load.image(
            "jumppad2",
            path.join(COMPONENT_GAME_PATH, "jumppad2.png")
        );
    ...
    loadForeground() {
        ...
        this.load.image(
            "water",
            path.join(FOREGROUND_TEMPLE_PATH, "Water.png")
        );
        this.load.image(
            "shadow-platform",
    ...
    loadAudio() {
        this.load.audio(
            "collected",
            path.join(AUDIO_GAME_PATH, "pickItem.mp3")
        );
        this.load.audio(
            "delivered",
            path.join(AUDIO_GAME_PATH, "delivery.mp3")
        );
        this.load.audio(
            "completed",
